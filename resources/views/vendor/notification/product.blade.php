@component('mail::layout')
    ...
    <div>
        ...
        @if($product->status === 1)
            ...
            <p class="text-center " style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; font-size: 18px;">You're Product for the shop <b>{{$user->shopName}}</b> has been Successfully Approve by Administrator. Ready to get started? <a>Sign In</a> to your account & Start your Business.</p>
            <div>
                <div>
                            ...
                            <table style="width:500px;padding:20px">
                                ...
                                <tr>
                                    <td style="width:60%;text-align:left">
                                        <div style="font-size:16px;line-height:26px;color:#000000;font-weight:500">Your product details are given below:</div>
                                        <div style="margin-top:10px;font-size:14px;line-height:22px;color:#626262;word-wrap:break-word"> {{$product->productName}}, {{$product->price}}, {{$product->quantity}}</div>
                                    </td>
        ...
        @else
            <p class="text-center " style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; font-size: 18px;">You're product name as <b>{{$product->productName}}</b> for shop  <b>{{$user->shopName}}</b> has been   <span style="color: red;">Rejected</span> by Administrator due to some reasons. For more information please <a href="mailto:administrator@example.com">Contact</a> to  web administrator.</p>
            <div>
                <div>
                    <div style="font-family:arial,sans-serif;width:500px;margin:0px auto">
                        <div style="width:500px;margin:5px 0px 10px 0px;background-color:#ffffff;border-radius:3px;border-top:1px solid #ddd;box-shadow:0px 3px 5px #b2b2b2">
